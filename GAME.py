...
#music_sound
pg.mixer.music.load("NICE-KNIGHT/music/Now-We-Ride(chosic.com).mp3")
pg.mixer.music.set_volume(0.4)
pg.mixer.music.play()
Blink_eff = pg.mixer.Sound("NICE-KNIGHT/music/shining-anime-sound-effect-240582.mp3")
Blink_eff.set_volume(0.2)
fin_cd = pg.mixer.Sound("NICE-KNIGHT/music/key-get-39925.mp3")
fin_cd.set_volume(0.5)
death_g = pg.mixer.Sound('NICE-KNIGHT/music/male-death-sound-128357.mp3')
death_g.set_volume(0.2)
dg = pg.mixer.Sound('NICE-KNIGHT/music/dragon-growl-37570.mp3')
dg.set_volume(0.4)
...
#back gound - font
bg_img = pg.image.load('NICE-KNIGHT/img/bg3.jpg')
...
char = pg.image.load('NICE-KNIGHT/img/pngegg.png')
